...
import cv2
import numpy as np
from fastapi import File, Header, Request
...
async def check_authorization(
	...
	if username != settings.API_AUTH_USERNAME or not request.app.pwd_context.verify(password, settings.API_AUTH_PASSWORD):
